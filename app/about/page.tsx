        ...
        <div className="min-h-screen bg-[var(--page-bg)] text-[var(--page-text)] pt-32 pb-20 px-6">
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-6xl font-bold text-[var(--page-text)] mb-6 tracking-tight">Redefining Luxury Travel</h1>
                ...
                <div className="space-y-16">
                    <section className="bg-[var(--surface-50)] border border-[var(--card-border)] rounded-3xl p-8 md:p-12">
                        <h2 className="text-3xl font-bold text-[var(--page-text)] mb-4">Our Mission</h2>
                    ...
                    <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="bg-[var(--surface-50)] border border-[var(--card-border)] rounded-3xl p-8">
